...
const char* ssid = "Gaadi";
const char* password = "12345678";

#define IN_1  D0     // L298N in1 motors Right       GPIO0(D3)
#define IN_2  D1     // L298N in2 motors Right       GPIO2(D4)
#define IN_3  D2    // L298N in3 motors Left        GPIO12(D6)
#define IN_4  D3    // L298N in4 motors Left        GPIO13(D7)
...
if(Data=='F')turnRight();
else if(Data=='B')turnLeft();
else if(Data=='R')forward();
else if(Data=='L')backward();
else if(Data=='S')Stop();
